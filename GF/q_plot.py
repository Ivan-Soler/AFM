                    ...
                    for file_name in x:
                        if "identification" in file_name and key in norm_dic:
                            ...
                            for line in f:  
                                ...
                                table_ensembles[key]['top-frac']+=np.array((abs(q_top-(inst+frac/2.0-ainst-afrac/2.0)),abs(q_top-(frac/2.0-afrac/2.0)),abs(q_top-(inst/2.0+frac/2.0-ainst/2.0-afrac/2.0))))
